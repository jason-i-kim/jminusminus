...
class JRemainderOp extends JBinaryExpression {
    ...
    /**
     * Generating code for the remainder operation involves generating code for the two
...
/**
 * The AST node for a binary left shift (<<) expression.
 */

class JBinLShiftOp extends JBinaryExpression {

    /**
     * Construct an AST for a binary left shift expression given its line number,
     * and the lhs and rhs operands.
     * 
     * @param line
     *            line in which the binlshift expression occurs in the
     *            source file.
     * @param lhs
     *            the lhs operand.
     * @param rhs
    ...
    public JBinLShiftOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "<<", lhs, rhs);
    }
    ...
    /**
     * Generating code for the BinLShift operation involves generating code for the two
     * operands, and then the BinLShift instruction.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
     *            .class file).
...
class JBinRShiftOp extends JBinaryExpression {

    /**
     * Construct an AST for a binary right shift expression given its line number,
     * and the lhs and rhs operands.
     * 
     * @param line
     *            line in which the binrshift expression occurs in the
     *            source file.
     * @param lhs
     *            the lhs operand.
     * @param rhs
    ...
    public JBinRShiftOp(int line, JExpression lhs, JExpression rhs) {
        super(line, ">>", lhs, rhs);
    }
...
class JLogRShiftOp extends JBinaryExpression {

    /**
     * Construct an AST for a Logical right shift expression given its line number,
     * and the lhs and rhs operands.
     * 
     * @param line
     *            line in which the logrshift expression occurs in the
     *            source file.
     * @param lhs
     *            the lhs operand.
     * @param rhs
    ...
    public JLogRShiftOp(int line, JExpression lhs, JExpression rhs) {
        super(line, ">>", lhs, rhs);
    }
    ...
    /**
     * Generating code for the LogRShift operation involves generating code for the two
     * operands, and then the LogRShift instruction.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
     *            .class file).
...
class JBitOrOp extends JBinaryExpression {
     ...
     * 
     * @param line
     *            line in which the BitOr expression occurs in the
     *            source file.
     * @param lhs
     *            the lhs operand.
     * @param rhs
    ...
    /**
     * Generating code for the BitOr operation involves generating code for the two
     * operands, and then the BitOr instruction.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
     *            .class file).
...
class JBitAndOp extends JBinaryExpression {
     ...
     * 
     * @param line
     *            line in which the BitAnd expression occurs in the
     *            source file.
     * @param lhs
     *            the lhs operand.
     * @param rhs
    ...
    /**
     * Generating code for the BitAnd operation involves generating code for the two
     * operands, and then the BitAnd instruction.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
     *            .class file).
...
class JBitXorOp extends JBinaryExpression {
     ...
     * 
     * @param line
     *            line in which the BitXor expression occurs in the
     *            source file.
     * @param lhs
     *            the lhs operand.
     * @param rhs
    ...
    /**
     * Generating code for the BitXor operation involves generating code for the two
     * operands, and then the BitXor instruction.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
     *            .class file).

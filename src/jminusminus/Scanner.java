...
class Scanner {
	...
	public Scanner(String fileName) throws FileNotFoundException {
		...
		reserved.put(BREAK.image(), BREAK);					// added step 1
		reserved.put(BYTE.image(), BYTE);					// added step 1
		reserved.put(CASE.image(), CASE);					// added step 1
		reserved.put(CATCH.image(), CATCH);					// added step 1
		reserved.put(CHAR.image(), CHAR);
		reserved.put(CLASS.image(), CLASS);
		reserved.put(CONST.image(), CONST);					// added step 1
		reserved.put(CONTINUE.image(), CONTINUE);			// added step 1
		reserved.put(DEFAULT.image(), DEFAULT);				// added step 1
		reserved.put(DO.image(), DO);						// added step 1
		reserved.put(DOUBLE.image(), DOUBLE);				// added step 1
		reserved.put(CONTINUE.image(), CONTINUE);			// added step 1
		reserved.put(ELSE.image(), ELSE);
		reserved.put(EXTENDS.image(), EXTENDS);
		reserved.put(FALSE.image(), FALSE);
		reserved.put(FINAL.image(), FINAL);					// added step 1
		reserved.put(FINALLY.image(), FINALLY);				// added step 1
		reserved.put(FLOAT.image(), FLOAT);					// added step 1
		reserved.put(FOR.image(), FOR);						// added step 1
		reserved.put(GOTO.image(), GOTO);					// added step 1
		reserved.put(IF.image(), IF);
		reserved.put(IMPLEMENTS.image(), IMPLEMENTS);		// added step 1
		reserved.put(IMPORT.image(), IMPORT);
		reserved.put(INSTANCEOF.image(), INSTANCEOF);
		reserved.put(INT.image(), INT);
		reserved.put(INTERFACE.image(), INTERFACE);			// added step 1
		reserved.put(LONG.image(), LONG);					// added step 1
		reserved.put(NATIVE.image(), NATIVE);				// added step 1
		...
		reserved.put(SHORT.image(), SHORT);					// added step 1
		reserved.put(STATIC.image(), STATIC);
		reserved.put(STRICTFP.image(), STRICTFP);			// added step 1
		reserved.put(SUPER.image(), SUPER);
		reserved.put(SWITCH.image(), SWITCH);				// added step 1
		reserved.put(SYNCHRONIZED.image(), SYNCHRONIZED);		// added step 1
		reserved.put(THIS.image(), THIS);
		reserved.put(THROW.image(), THROW);					// added step 1
		reserved.put(THROWS.image(),THROWS);					// added step 1
		reserved.put(TRANSIENT.image(), TRANSIENT);			// added step 1
		reserved.put(TRUE.image(), TRUE);
		reserved.put(TRY.image(), TRY);						// added step 1
		reserved.put(VOID.image(), VOID);
		reserved.put(VOLATILE.image(), VOLATILE);			// added step 1
	...
	public TokenInfo getNextToken() {
			...
			if (ch == '>') {
				...
				if (ch == '>') {
                    ...
                    if (ch == '=') {
                        ...
                        return new TokenInfo(LOGRSHIFT, line);
                    }
				} else if (ch == '=') {
				    nextCh();
                    return new TokenInfo(BINRSHIFT_ASSIGN, line);
				} else {
					return new TokenInfo(BINRSHIFT, line);
                }
			} else if (ch == '=') {
			    nextCh();
		...
		case '<':
			...
			if (ch == '=') {
                ...
                if (ch == '=') {
                    nextCh();
                    return new TokenInfo(BINLSHIFT_ASSIGN, line);
                } else {
                    return new TokenInfo(BINLSHIFT, line);
                }
			} else {
